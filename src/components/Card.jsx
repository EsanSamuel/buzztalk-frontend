   ...
   /* const joinRoom = () => {
    ...
    return (
        <div className='h-auto mt-5 w-full card rounded-[10px]   text-[#e1d9d1]'>
            ...
            {imageModal && (
                <div className='fixed sm:top-20 sm:bottom-20 top-[10%] bottom-[10%] z-10 bg-[#1c1c24] sm:p-2 p-1 card rounded sm:left-20 sm:right-20 left-2 right-2 border border-[#5f5f5f] animate-slide-in3'>
